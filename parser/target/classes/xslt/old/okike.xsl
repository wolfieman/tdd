<xsl:stylesheet
  ...
  <xsl:template name="processBillPackageInfo">
    ...
    <BillPackage>
      ...
      <xsl:if test="string-length($changeBillPackage) > 0 and $bse/newApplicationId/text() and not($bse/applicationId/text() = $bse/newApplicationId/text())">
        <ChangedFamilyID>
      ...
      <xsl:if test="string-length($newBillPackage) > 0 or string-length($changeBillPackage) > 0">
        ...
        <xsl:if test="$memberBenefitInfo/coverageDates">
          <RenewalDay>
            <xsl:choose>
        ...
        <xsl:if test="$memberBenefitInfo/initialPayment/Payment/text() or $memberBenefitInfo/recurringPayment/Payment/text() or $billInformation/billPaymentMethod/text()">
          <BillPaymentMethod>
            <xsl:choose>
              <xsl:when test="$memberBenefitInfo/recurringPayment/Payment/CreditCard/text() or $billInformation/billPaymentMethod/text() = 'RECURRING_CREDIT_CARD'">
                <xsl:value-of select="'RCC'"/>
              </xsl:when>
              <xsl:when test="$memberBenefitInfo/recurringPayment/Payment/ACH/text() or $billInformation/billPaymentMethod/text() = 'RECURRING_EFT'">
                <xsl:value-of select="'RFT'"/>
              </xsl:when>
              <xsl:when test="$memberBenefitInfo/initialPayment/Payment/CreditCard/text() or $billInformation/billPaymentMethod/text() = 'NON_RECURRING_CREDIT_CARD'">
                <xsl:value-of select="'NCC'"/>
              </xsl:when>
              <xsl:when test="$memberBenefitInfo/initialPayment/Payment/ACH/text() or $billInformation/billPaymentMethod/text() = 'NON_RECURRING_EFT'">
                <xsl:value-of select="'NFT'"/>
              </xsl:when>
              <xsl:when test="$billInformation/billPaymentMethod/text() = 'CHECK'">
  ...
  <xsl:template name="isNewBillPackage">
    <xsl:param name="bse"/>
    <!--todo-->
    <xsl:if test="$bse/transaction/memberTransactionTypes/text() = 'ADD_SUBSCRIBER'">true</xsl:if>
  </xsl:template>
    ...
    <xsl:if test="string-length($newSubscriber) > 0 or string-length($changeSubscriber) > 0 or string-length($generalDependentChange) > 0">
      <MemberInfo>
        <xsl:if test="string-length($newSubscriber) > 0 or string-length($changeSubscriber) > 0">
          ...
          <xsl:if test="string-length($memberId) > 0">
          ...
          <xsl:if test="substring($benefit/carrierDefinedFields/carrierDefinedField[type/text() = 'HIPAA_IND']/value,1,1) = 'Y' or substring($benefit/carrierDefinedFields/carrierDefinedField[type/text() = 'HIPAA_IND']/value,1,1) = 'T'">
            <HIPAACntrctTierCode>
              <xsl:choose>
                ...
                <xsl:when test="$benefit/coverageLevelName/text() = 'EmployeeAndSpouseOrCivilUnionParter'">
                  SUBSCU
                </xsl:when>
              </xsl:choose>
            </HIPAACntrctTierCode>
          ...
          <xsl:if test="$benefit/carrierDefinedFields/carrierDefinedField[type/text() = 'FINAL_RATEUP_FACTOR']/value">
          ...
          <xsl:if test="$benefit/carrierDefinedFields/carrierDefinedField[type/text() = 'INDIVIDUAL_RATEUP_FACTOR']/value">
  ...
  <xsl:template name="processDependent">
    ...
    <xsl:if test="string-length($newDependent) > 0 or string-length($changeDependent) > 0">
      <DependentInfo>
        ...
        <xsl:if test="$depMemberPersonalId/gender">
          <DependentSexCode>
            <xsl:choose>
        ...
        <xsl:if test="$depBenefit/carrierDefinedFields/carrierDefinedField[type/text() = 'INDIVIDUAL_RATEUP_FACTOR']/value">
        ...
        <xsl:if test="$depBenefit/carrierDefinedFields/carrierDefinedField[type/text() = 'FINAL_RATEUP_FACTOR']/value">
        ...
        <xsl:if test="$depBenefit/carrierDefinedFields/carrierDefinedField[type/text() = 'HIPAA_IND']/value">
